...
<head>
    ...
    <style>
        ...
        /* Styles spécifiques au contenu des Achats (table, boutons) */
        h2 {
            color: var(--pharma-blue);
            ...
            <div class="container">
                ...
                <nav class="navbar navbar-light bg-light mb-4">
                    <div class="container-fluid">
                        ...
                        <!-- Zone de recherche pour les achats -->
                        <form class="d-flex" action="${pageContext.request.contextPath}/achats" method="get">
                            <input type="hidden" name="action" value="search">
                            <div class="input-group">
                                <input type="text" 
                                       class="form-control" 
                                       name="searchTerm" 
                                       placeholder="Rechercher un achat par ID..."
                ...
                <!-- Contenu principal de la page Achats -->
                <div class="container">
                    <div class="header-section">
                        <h2><i class="fas fa-shopping-cart"></i> Gestion des Achats</h2>
                        <a href="${pageContext.request.contextPath}/achats?action=add" class="btn btn-primary">
                            <i class="fas fa-plus-circle"></i> Enregistrer un nouvel achat
                        </a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <c:forEach var="achat" items="${requestScope.achats}">
                                    <tr>
                                        <td>${achat.id}</td>
                                        <td><fmt:formatDate value="${achat.dateAchat}" pattern="dd/MM/yyyy"/></td>
                                        <td><fmt:formatNumber value="${achat.montantTotal}" type="currency" currencySymbol="DH " minFractionDigits="2" maxFractionDigits="2"/></td>
                                        <td>${achat.nomFournisseur}</td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/achats?action=details&id=${achat.id}" class="btn btn-info btn-sm">Détails</a>
                                            <a href="${pageContext.request.contextPath}/achats?action=delete&id=${achat.id}" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet achat ?');">Supprimer</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                <c:if test="${empty requestScope.achats}">
                                    <tr>
